...
from mirrorduo.model.mirrorduo_conditional_unet1d import MirrorDuoDiffusionUNet
from mirrorduo.model.mirrorduo_obs_encoder import MirrorDuoObsEnc


class MirrorDuoDiffusionImagePolicy(BaseImagePolicy):
    def __init__(
        self,
        shape_meta: dict,
        ...
        **kwargs,
        ...
        tcp_centered = "agentview_image_tcp_centered" in obs_shape_meta

        if tcp_centered:
            obs_shape = obs_shape_meta["agentview_image_tcp_centered"]["shape"]
        else:
            obs_shape = obs_shape_meta["agentview_image"]["shape"]

        self.enc = MirrorDuoObsEnc(
            obs_shape=obs_shape,
        ...
        self.diff = MirrorDuoDiffusionUNet(
            act_emb_dim=64,
            local_cond_dim=None,
    ...
    def compute_loss(self, batch):
        ...
        nobs_features = self.enc(nobs)  # B, T, Do
        ...
        pred = self.diff(noisy_trajectory, timesteps, local_cond=None, global_cond=global_cond)
